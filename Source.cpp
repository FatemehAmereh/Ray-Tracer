...
int main() {
    ...
    Plane planes[planeCount] = {
        ...
        Plane(glm::vec3(0.7071067f,0.0f,0.7071067f), glm::vec3(-5.0f,0,0), 5.0f, Material(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 1.0f, 1.0f), 1000)), //mirror1
        Plane(glm::vec3(0.7071067f,0.0f,0.7071067f), glm::vec3(-5.0f,0,0), 5.5f, Material(glm::vec3(1.0f, 0.2f, 0.9f), glm::vec3(0.0f, 0.0f, 0.0f), 1000)), //background
